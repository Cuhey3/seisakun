 ...
 * <p>
 * A Java implementation of the MT19937 (Mersenne Twister) pseudo random number
 * generator algorithm based upon the original C code by Makoto Matsumoto and
 ...
 * java.util.Random with the additional advantage of having a far longer period
 * and the ability to use a far larger seed value.
 * <p>
 * This is <b>not</b> a cryptographically strong source of randomness and should
 * <b>not</b> be used for cryptographic systems or in any other situation where
 * true random numbers are required.
 * <p>
 * <!-- Creative Commons License -->
 * <a href="http://creativecommons.org/licenses/LGPL/2.1/"><img alt="CC-GNU
 * LGPL" border="0" src="http://creativecommons.org/images/public/cc-LGPL-a.png"
 * /></a><br />
...
public class MTRandom extends Random {
     ...
     * <pre>
     * mt.setSeed(12345);
     * int foo = mt.nextInt(16) + (mt.nextInt(16) << 16);</pre> will not give
     * the same result as
     * <pre>
     * mt.setSeed(12345);
     ...
     * <pre>    byte[] { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06 }</pre> becomes
